...
class RectangularRoom(object):
    ...
    def getNumCleanedTiles(self):
        ...
        tot = 0
        for tiles in self.room:
            if self.room[tiles] == True:
                tot += 1
    ...
    def getCoverage(self):
        return (self.getNumCleanedTiles() / self.getNumTiles())
    ...
    def isPositionInRoom(self, pos):
        ...
        return (math.floor(pos.getX()),math.floor(pos.getY())) in self.room
...
# jack = StandardRobot(room,1)
# for i in range(10):
#     jack.updatePositionAndClean()
#     print(jack.getRobotPosition())
#     print(jack.direction)
    ...
    for i in range(num_trials):
        ...
        while room.getCoverage() < min_coverage:
            ...
            for r in robots:
                ...
                if room.getCoverage() >= min_coverage:
                    break
            count += 1
        mean.append(count)
        anim.done()
        
    avg_steps = sum(mean)/num_trials
    return(avg_steps)
    
    # raise NotImplementedError

# Uncomment this line to see how much your simulation takes on average
runSimulation(1, 1.0, 5, 5, 1, 1, StandardRobot)
...
# runSimulation(1,1,5,5,1,1,RandomWalkRobot)
